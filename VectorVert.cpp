...
//VectorVert::VectorVert() : Vector() {}

//VectorVert::VectorVert(const size_t len, const std::string fname) : Vector(len, fname) {}

//VectorVert::VectorVert(const Vector& other) : Vector(other) {}
